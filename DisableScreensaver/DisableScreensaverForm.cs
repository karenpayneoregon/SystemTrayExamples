...
namespace DisableScreensaver
{
    public partial class DisableScreensaverForm : Form
    {
        ...
        {
            var disabled = ((ToolStripMenuItem)sender).Checked;
        ...
        {
            aboutTextBox.Text =
                $"Disable Screensaver version {System.Reflection.Assembly.GetExecutingAssembly().GetName().Version}\r\n\r\nKaren's simple example";
